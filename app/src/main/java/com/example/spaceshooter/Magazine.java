...
public class Magazine {
    ...
    public Magazine(Context context, int screenSizeX, int screenSizeY, SoundPlayer soundPlayer, int X, int Y) {
        mScreenSizeX = screenSizeX;
        mScreenSizeY = screenSizeY;
        mSoundPlayer = soundPlayer;
        Random random = new Random();
        mBitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.mag1);
