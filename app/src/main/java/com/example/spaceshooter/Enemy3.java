...
public class Enemy3 {
    ...
    public Enemy3(Context context, int screenSizeX, int screenSizeY, SoundPlayer soundPlayer) {
        ...
        mHP = (int) ((6 + H) * Game.getDifficulty());
        Random random = new Random();
        mBitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.enemy_red_3);
        mBitmap = Bitmap.createScaledBitmap(mBitmap, mBitmap.getWidth() * 3 / 5, mBitmap.getHeight() * 3 / 5, false);
        mSpeed = random.nextInt(2) + 2 + ES;
